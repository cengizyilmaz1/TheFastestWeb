...
export async function resetIntegrationData(): Promise<void> {
  await fixtureSql()`TRUNCATE public.founder_site_invitations,public.analytics_events,public.ad_reservations,public.ad_inventory,public.payment_events, public.payment_ledger, public.subscriptions,
