...
export default function LinksPage() {
  return (
    <div style={{ position: "absolute", left: "-9999px", top: "-9999px", overflow: "hidden", height: "1px", width: "1px" }}>
      <a href="https://verifieddr.com/website/thefastestweb-site" target="_blank"><img src="https://verifieddr.com/badge/thefastestweb-site.svg" alt="Verified DR - Verified Domain Rating for thefastestweb.site" width={220} height={68} /></a>
      <a href="https://startupfa.me/s/thefastestweb?utm_source=thefastestweb.site" target="_blank"><img src="https://startupfa.me/badges/featured/default.webp" alt="TheFastestWeb - Featured on Startup Fame" width={171} height={54} /></a>
      <a href="https://domainrank.app" target="_blank"><img src="https://domainrank.app/api/badge/thefastestweb.site?theme=dark" alt="thefastestweb.site Domain Rating" width={360} height={80} /></a>
      ...
      <a href="https://submitmysaas.com" target="_blank" rel="noopener noreferrer"><img src="https://submitmysaas.com/featured-badge.png" alt="Featured on SubmitMySaas" style={{ height: "54px", width: "auto" }} /></a>
      ...
      <a href="https://launch-list.org/product/thefastestweb" target="_blank"><img src="https://launch-list.org/badges/svg/launch_list_badge_live.svg" alt="Launch List Badge" style={{ height: "50px" }} /></a>
      <a href="https://fazier.com/launches/thefastestweb.site" target="_blank"><img src="https://fazier.com/api/v1//public/badges/launch_badges.svg?badge_type=featured&theme=light" width={250} alt="Fazier badge" /></a>
      <a href="https://turbo0.com/item/thefastestweb" target="_blank" rel="noopener noreferrer"><img src="https://img.turbo0.com/badge-listed-light.svg" alt="Listed on Turbo0" style={{ height: "54px", width: "auto" }} /></a>
