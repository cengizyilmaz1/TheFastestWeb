...
export const notificationTemplates = {
  ...
  performance_dropped: { subject: "Your website performance dropped", category: "performance", text: "A recent measurement detected a performance decrease. Review the evidence in your dashboard." },
  ...
  badge_warning: { subject: "Check your website badge", category: "badge", text: "Your badge needs attention. Review its current eligibility in your dashboard." },
  ...
  payment_success: { subject: "Your payment was confirmed", category: "transactional", text: "Your payment was confirmed. Review your purchase and access in the dashboard." },
  ...
  subscription_event: { subject: "Your subscription changed", category: "transactional", text: "Your subscription status has changed. Review its current status in the dashboard." },
  ad_approved: { subject: "Your advertisement was approved", category: "transactional", text: "Your advertisement was approved. Its placement and dates are available in your dashboard." },
