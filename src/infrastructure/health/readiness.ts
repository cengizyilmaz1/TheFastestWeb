      ...
      (async () => {
        ...
        await db.execute(sql`
          select s.normalized_url, v.id, r.key, j.id, j.job_key, j.status,
            ...
            invitation.inviter_user_id,invitation.invited_user_id,invitation.expires_at
          from public.sites s
          ...
          cross join public.founder_site_invitations invitation
          where false
        `);
          ...
          select (
            ...
            or exists (
              select 1 from unnest(array[
                ...
                'site_awards','site_screenshots','admin_roles','ad_inventory','ad_reservations','analytics_events','founder_site_invitations'
