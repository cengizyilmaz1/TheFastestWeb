...
const versions = ["0000_snapshot_baseline", "0001_m1_verified_results", "0002_m2_job_ledger", "0003_m3_providers", "0004_m5_product_model", "0005_ad_inventory", "0006_domain_analytics"] as const;
