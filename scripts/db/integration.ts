...
async function main(): Promise<void> {
  ...
  try {
    ...
    assert.deepEqual({ ...state }, { migrations: 12, rls: 0, verified: 0 });
    ...
    assert.deepEqual(upgradeLog, ["Applied 0002_m2_job_ledger.", "Applied 0003_m3_providers.", "Applied 0004_m5_product_model.","Applied 0005_ad_inventory.","Applied 0006_domain_analytics.","Applied 0007_founder_invitations.","Applied 0008_indietools_categories.","Applied 0009_founder_urls_redirects.","Applied 0010_outbound_clicks.","Applied 0011_redirect_statistics."]);
