...
- `0008_indietools_categories.sql` adds 15 IndieTools category records while preserving the eight historical website types, existing IDs, category assignments and operator customizations. The legacy enum and schema fingerprint remain unchanged. See [CATEGORIES.md](CATEGORIES.md).
